...
CREATE SCHEMA IF NOT EXISTS BOOKS.RAW;
CREATE SCHEMA IF NOT EXISTS BOOKS.CONFIG;
CREATE SCHEMA IF NOT EXISTS BOOKS.KDP;
CREATE SCHEMA IF NOT EXISTS BOOKS.RPT;
